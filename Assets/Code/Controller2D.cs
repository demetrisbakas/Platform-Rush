...
{
    public float climbVelocityY, descendVelocityY;
    ...
    public float GetClimbVelocityY()
    {
        return climbVelocityY;
    }

    public float GetDescendVelocityY()
    {
        return descendVelocityY;
    }
}
